...
namespace Assets.Sun.Task01
{
	...
	public class CompScreenPreview : MonoBehaviour, IWidgetController
	{
		public CompViewPreview CompViewPreview;
		...
		{
			//? to Screen for all
			CompViewPreview.OnWidgetEnable();
		}

		public void OnWidgetDisable()
		{
			//? to Screen for all
			CompViewPreview.OnWidgetDisable();
		}
	}
}
